        ...
        <div style="display:flex;align-items:center;gap:14px;">
            ...
            <div style="position:relative;">
                ...
                <div id="invNotifDropdown"
                    ...
                    <div id="invNotifList" style="max-height:60vh;overflow-y:auto;"></div>
                </div>
            </div>
        </div>
    </div>
...
function loadInvNotifications() {
    fetch('/notifications/inventory')
        ...
        .then(items => {
            ...
            if (!items.length) {
                list.innerHTML = '<p style="padding:16px;color:#999;text-align:center;font-size:13px;">No inventory alerts</p>';
                return;
            }
            const icons = { '⚠ Low Stock Warning': '⚠️', '❌ Out of Stock': '❌', '⏰ Expiry Warning': '⏰', 'Stock Added': '✅', 'Stock Updated': '📝', 'Reorder Level Updated': '🔧' };
            list.innerHTML = items.map(n => `
                <div onclick="markInvRead(${n.id}, this)"
                    ...
                    <div style="display:flex;align-items:flex-start;gap:8px;">
                        <span style="font-size:16px;flex-shrink:0;">${icons[n.title] || '📦'}</span>
