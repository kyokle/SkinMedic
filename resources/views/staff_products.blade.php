     ...
     onerror="this.src='{{ asset('uploads/default.png') }}'">
                ...
                <div class="action-buttons">
                    <button class="edit-btn" onclick="openEditModal(
                        '{{ $row->product_id }}',
                        '{{ addslashes(htmlspecialchars($row->product_name,     ENT_QUOTES)) }}',
                        '{{ addslashes(htmlspecialchars($row->description,      ENT_QUOTES)) }}',
                        '{{ addslashes(htmlspecialchars($row->category,         ENT_QUOTES)) }}',
                        '{{ addslashes(htmlspecialchars($row->brand,            ENT_QUOTES)) }}',
                        '{{ addslashes(htmlspecialchars($row->supplier,         ENT_QUOTES)) }}',
                        '{{ addslashes(htmlspecialchars($row->batch_number,     ENT_QUOTES)) }}',
                        '{{ $row->cost_price }}',
                        '{{ $row->selling_price }}',
                        '{{ addslashes(htmlspecialchars($row->storage_location, ENT_QUOTES)) }}',
                        '{{ $row->status }}'
                    )">✏ Edit</button>
                    <form method="POST" action="{{ route('staff.products.delete') }}"
